...
#         'SAVE_FILE': 'TEST2_UNCOMPRESSED',
#         'OVERSAMPLING_METHOD': 'random',
#         'BEST_MODELS_NAME': 'Decision Tree',
#     },
#     "clonal_breadth": {
#         'SAVE_FILE': 'TEST2_UNCOMPRESSED',
#         'OVERSAMPLING_METHOD': 'random',
...
model_names = []
all_predictions = {}
all_y_test = {} # this is all going to be the same
    ...
    if os.path.exists(test_set_csv_filename):
        try:
            ...
            if 'target' in test_df.columns:
                ...
                y_test_current = test_df['target'].values
...
if all_predictions:
    ...
    if unique_labels is not None:
        ...
        print(f"{final_predictions} (predictions)")
        print(f"{list(all_y_test.values())[0]} (real)")
