...
from exploration.SMOTE_utils import (
    ...
    correct_permutation_test, repeated_cv_confidence_intervals
)
...
for oversample_method in OVERSAMPLING_METHODS:
    ...
    def train_and_predict_best_model(X_train, y_train, X_test, y_test, data_name):
        ...
        for name, model in models.items():
            ...
            metrics = repeated_cv_confidence_intervals(cloned_model, X_train, y_train, n_repeats=1000, n_folds=5, ci=0.95)

            p_value, observed_score, _ = correct_permutation_test(cloned_model, X_train, y_train, n_folds=5, n_permutations=1000)
