...
csv_files = [
    ...
    "../data_created/SMOTE/Measles/TEST_UNCOMPRESSED_UNBALANCED_TEST_cytokines_data.csv",
    "../data_created/SMOTE/Measles/TEST_UNCOMPRESSED_UNBALANCED_TEST_cytometry_data.csv",
